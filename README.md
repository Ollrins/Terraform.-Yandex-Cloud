...
- Platform "standard-v4" not found - не нашёл такую платформу, standard-v3 использовался
...
### 1.6 В процессе обучения могут пригодиться параметры preemptible = true и core_fraction=5 в параметрах ВМ для экономии облачных ресурсов, если нужно будет оставить машину на длительное время, но она не нужна на постоянной основе и не производит вычислений
